...
const FoundingRibbon = ({
  ...
  return <div className="mx-auto mt-6 w-full max-w-4xl px-4" aria-live="polite">
      <div className={`text-center font-display rounded-2xl border px-8 py-6 shadow-2xl transition-all duration-700 backdrop-blur-3xl relative overflow-hidden group ${isOver5000 ? 'bg-gradient-to-r from-red-500/10 to-red-600/10 border-red-500/30 text-red-600 dark:text-red-400 shadow-red-500/20' : 'bg-gradient-to-br from-card/20 via-background/10 to-card/30 border-border/20 text-foreground shadow-lg hover:bg-gradient-to-br hover:from-lime/20 hover:via-pink/10 hover:to-lime/15 hover:border-lime/40 hover:shadow-[0_0_60px_rgba(193,255,114,0.4)] hover:scale-[1.03]'} before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/10 before:via-transparent before:to-pink/10 before:opacity-0 before:transition-opacity before:duration-700 hover:before:opacity-100 after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-lime/5 after:to-transparent after:opacity-0 after:transition-opacity after:duration-700 hover:after:opacity-100`}>
