...
const FoundingRibbon = ({
  ...
  return <div className="mx-auto mt-6 w-full max-w-4xl px-4" aria-live="polite">
      <div className={`text-center font-display rounded-2xl border px-8 py-6 shadow-2xl transition-all duration-700 backdrop-blur-3xl relative overflow-hidden group ${isOver5000 ? 'bg-gradient-to-r from-red-500/20 to-red-600/20 border-red-500/40 text-red-600 dark:text-red-400 shadow-red-500/30 hover:shadow-red-500/50' : 'bg-gradient-to-br from-lime/15 via-pink/8 to-lime/12 border-lime/30 text-foreground shadow-[0_0_40px_rgba(193,255,114,0.3)] hover:bg-gradient-to-br hover:from-lime/25 hover:via-pink/15 hover:to-lime/20 hover:border-lime/50 hover:shadow-[0_0_80px_rgba(193,255,114,0.5)] hover:scale-[1.03]'} before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/15 before:via-transparent before:to-pink/15 before:opacity-60 before:transition-all before:duration-700 hover:before:opacity-100 hover:before:from-white/25 hover:before:to-pink/25 after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-lime/8 after:to-transparent after:opacity-70 after:transition-all after:duration-700 hover:after:opacity-100 hover:after:via-lime/15 after:animate-pulse`}>
