  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // ZeroToken pricing button variants - Enhanced and vibrant
        "pricing-pink": "relative bg-gradient-to-r from-pink/20 to-pink/30 text-pink font-semibold border-2 border-pink/40 hover:from-pink hover:to-pink/90 hover:text-white hover:shadow-xl hover:shadow-pink/40 hover:scale-105 active:scale-95 transition-all duration-400 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-skew-x-12 before:translate-x-[-100%] hover:before:translate-x-[200%] before:transition-transform before:duration-600",
        "pricing-lime": "relative bg-gradient-to-r from-lime/20 to-lime/30 text-lime font-semibold border-2 border-lime/40 hover:from-lime hover:to-lime/90 hover:text-white hover:shadow-xl hover:shadow-lime/40 hover:scale-105 active:scale-95 transition-all duration-400 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-skew-x-12 before:translate-x-[-100%] hover:before:translate-x-[200%] before:transition-transform before:duration-600",
        "pricing-lavender": "relative bg-gradient-to-r from-lavender/20 to-lavender/30 text-lavender font-semibold border-2 border-lavender/40 hover:from-lavender hover:to-lavender/90 hover:text-white hover:shadow-xl hover:shadow-lavender/40 hover:scale-105 active:scale-95 transition-all duration-400 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-skew-x-12 before:translate-x-[-100%] hover:before:translate-x-[200%] before:transition-transform before:duration-600",
